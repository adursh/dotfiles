return {
    ...
    config = function()
        require("toggleterm").setup({
            ...
            shade_terminals = false, -- NOTE: takes priority over highlights, so set false if you customize highlights
            -- shading_factor = '<number>', -- % to lighten dark terminal bg (default: -30)
